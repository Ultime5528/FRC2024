...
class Pivot(SafeSubsystem):
    ...
    interpolation_points_x = autoproperty([-8.0, -6.8, -6.3, -6.1, -4.1, -0.6, 1.45, 5.05, 9.8], -6.8, -6.1, -4.1, -0.6, 2.5, 5.05, 9.8])
    interpolation_points_y = autoproperty([15, 16, 17, 18, 28, 35, 48, 55, 64], 14, 15, 22, 32, 43, 53, 64])
