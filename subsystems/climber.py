...
class Climber(SafeSubsystem):
    ...
    def __init__(self):
        ...
        self.climb_motor_right = rev.CANSparkMax(ports.climber_motor_right,
                                                 rev.CANSparkMax.MotorType.kBrushless)
        configureLeader(self.climb_motor_right, "brake", False)
    def extend(self):
        self.climb_motor_left.set(self.climber_speed_up)
        self.climb_motor_right.set(self.climber_speed_up)

    def retract(self):
        self.climb_motor_left.set(self.climber_speed_down)
        self.climb_motor_right.set(self.climber_speed_down)
